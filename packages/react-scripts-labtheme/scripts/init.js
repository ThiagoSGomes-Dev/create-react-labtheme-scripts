...
const initLabTheme = require('./init-labtheme');
...
module.exports = function (
  ...
  appPackage = initLabTheme.fnUpdateAppPackage(
    appPackage,
    appPath,
    appName,
    verbose,
  ...
  // labtheme intercept -- stop the standard create-react-app init here... labtheme will take over and display the final message.
  initLabTheme.fnFinish(
    appPackage,
    appPath,
    appName,
    verbose,
